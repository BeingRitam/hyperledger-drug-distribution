...
async function main(certificatePath, privateKeyPath) {
	...
	try {
		...
		const wallet = await Wallets.newFileSystemWallet('./identity/retailer');
...
const certificatePath = './../../network/crypto-config/peerOrganizations/retailer.pharma.net/users/Admin@retailer.pharma.net/msp/signcerts/Admin@retailer.pharma.net-cert.pem';
const privateKeyPath = './../../network/crypto-config/peerOrganizations/retailer.pharma.net/users/Admin@retailer.pharma.net/msp/keystore/priv_sk';
