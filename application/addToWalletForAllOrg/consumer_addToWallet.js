...
const certificatePath = './../../network/crypto-config/peerOrganizations/consumer.pharma.net/users/Admin@consumer.pharma.net/msp/signcerts/Admin@consumer.pharma.net-cert.pem';
const privateKeyPath = './../../network/crypto-config/peerOrganizations/consumer.pharma.net/users/Admin@consumer.pharma.net/msp/keystore/priv_sk';
