...
echo "Updating chaincode on peer0.manufacturer.pharma.net ..."
installChaincode 0 'manufacturer' $VERSION $PACKAGE_NAME
echo "Updating chaincode on peer1.manufacturer.pharma.net ..."
installChaincode 1 'manufacturer' $VERSION $PACKAGE_NAME
echo "Updating chaincode on peer0.distributor.pharma.net ..."
installChaincode 0 'distributor' $VERSION $PACKAGE_NAME
echo "Updating chaincode on peer1.distributor.pharma.net ..."
installChaincode 1 'distributor' $VERSION $PACKAGE_NAME
echo "Updating chaincode on peer0.retailer.pharma.net ..."
installChaincode 0 'retailer' $VERSION $PACKAGE_NAME
echo "Updating chaincode on peer1.retailer.pharma.net ..."
installChaincode 1 'retailer' $VERSION $PACKAGE_NAME
echo "Updating chaincode on peer0.consumer.pharma.net ..."
installChaincode 0 'consumer' $VERSION $PACKAGE_NAME
echo "Updating chaincode on peer1.consumer.pharma.net ..."
installChaincode 1 'consumer' $VERSION $PACKAGE_NAME
echo "Updating chaincode on peer0.transporter.pharma.net ..."
installChaincode 0 'transporter' $VERSION $PACKAGE_NAME
echo "Updating chaincode on peer1.transporter.pharma.net ..."
installChaincode 1 'transporter' $VERSION $PACKAGE_NAME

# Upgrade chaincode on the channel using peer0.manufacturer
echo "Upgrading chaincode on channel using peer0.manufacturer.pharma.net ..."
